...
var routes = [
    ...
    { path: 'admagenda', loadChildren: './admagenda/admagenda.module#AdmagendaPageModule' }
];
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ljc\luiz\src\main.ts */"./src/main.ts");
