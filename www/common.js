...
var ProvidersService = /** @class */ (function () {
    function ProvidersService(http, httpmodule, alerta) {
        this.http = http;
        ...
        // };
        this.url = "http://ljcdev.com.br/site/php/";
        console.log('Hello ServidorProvider Provider');
    }
    ProvidersService.prototype.urlGet = function () {
        return this.url;
    };
    ProvidersService.prototype.getHora = function () {
    };
    ProvidersService.prototype.alertas = function (titulo, msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alerta.create({
                            header: titulo,
                            message: msg,
                            buttons: ['OK']
                        })];
